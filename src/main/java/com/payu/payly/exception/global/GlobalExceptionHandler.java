package com.payu.payly.exception.global;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // 405
    protected ResponseEntity<Object> handleHttpRequestMethodNotAllowed(final HttpRequestMethodNotSupportedException ex, final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
        logger.info(ex.getClass().getName());
        //
    ...
    // 408
    protected ResponseEntity<Object> handleHttpRequestTimeOutException(final HttpTimeoutException ex, final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
        logger.info(ex.getClass().getName());
        //
        final StringBuilder builder = new StringBuilder();
        builder.append(ex.getLocalizedMessage());
        builder.append(" Request is timed out. Do try again after 3 minutes ");
        Objects.requireNonNull(ex.getLocalizedMessage());

        final ApiError apiError = new ApiError(HttpStatus.REQUEST_TIMEOUT, ex.getLocalizedMessage(), builder.toString());
        return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
    }
